 ...
 *
 * The anon key is designed to be exposed in client-side code — Row-Level
 * Security policies in your Supabase project are what actually protect data.
 * After creating your project, paste the values from
